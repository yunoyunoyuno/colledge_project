...
DT_FORMAT = "%H:%M:%S";
MULTIPLIER = 2; LS_ITER = 3000 ;VNS_ITR = 2;TIME_PORTION = 60;
...
y = "";
while(y != "y" and y != "n"):
    y = input("Random check cache accuracy? <This will take time for a while.> (y/n) ")
    if(y != "y" and y != "n"): print("Please choose either y or n") 
if(y == "y"):
    start = T.time();
    #time = ["12:15:00","12:45:00","6:15:00","6:45:00","19:15:00","19:45:00","00:00:00"]
    time = ["12:15:00","12:45:00","6:15:00"];
    for i in range(len(time)): Utils.check_accuracy(time[i],i);
    print("Testing accuracy time",T.time() - st,"s");

print("It's time to execute ...");
T.sleep(1.5);
